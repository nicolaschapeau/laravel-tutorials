<nav class="navbar navbar-default" style="background: white; border-bottom: 1px solid #eee;">
    <div class="container-fluid">
        ...
        <div class="navbar-header d-flex flex-row justify-content-between align-items-center" id="bs-example-navbar-collapse-1" style="width: 100%;">
            ...
            <ul class="nav navbar-nav col-3 d-flex flex-row justify-content-between align-items-center" style="min-width: 150px; max-width: 200px;">
                <a href="#" class="btn btn-primary" style="margin-top:5px; width: 100%; min-width: 150px;">Ask A Question</a>
            </ul>
        </div><!-- /.navbar-collapse -->
    </div><!-- /.container-fluid -->
</nav>